    ...
    <div className="flex flex-col items-center">
      <div className="flex flex-wrap w-full pt-10 lg:px-20 xl:px-40 mx-auto border-t-2 border-white">
        ...
        <div className="flex gap-10 flex-wrap  justify-center mx-auto lg:mx-0">
          ...
          <div className="mt-9">
            <h1 className="mb-3 text-white font-bold text-lg">
              Stay up to date
            </h1>
      ...
      <h3 className="text-white m-5 text-sm">
        All rights reserved. Copyright © 2024 Diamas by Aditya Dhawan ( A
        Kasturi Jewellers Craft )
      </h3>
    </div>
  );
};
